...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pose gel, nail art éditorial, vibe streetwear luxe. Paris 12e." },
      { property: "og:title", content: "nailzxava — Editorial Nails by Ava" },
      { property: "og:description", content: "Pose gel, nail art éditorial, vibe streetwear luxe. Paris 12e." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "nailzxava — Editorial Nails by Ava" },
      { name: "twitter:description", content: "Pose gel, nail art éditorial, vibe streetwear luxe. Paris 12e." },
